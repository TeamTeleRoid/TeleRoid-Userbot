# TeleRoid - UserBot
# Copyright (C) 2020 TeamTeleRoid
# This file is a part of < https://github.com/TeamTeleRoid/TeleRoid-Userbot/ >
# PLease read the GNU Affero General Public License in <https://www.github.com/TeamTeleRoid/TeleRoid-Userbot/blob/main/LICENSE/>.
